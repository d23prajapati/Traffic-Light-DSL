...
public abstract class ComponentImpl extends MinimalEObjectImpl.Container implements Component {
	...
	protected EClass eStaticClass() {
		return TrafficLightSystemPackage.Literals.COMPONENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TrafficLightSystemPackage.COMPONENT__NAME, oldName,
					name));
	}
