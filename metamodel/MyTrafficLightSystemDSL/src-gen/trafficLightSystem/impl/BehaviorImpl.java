 ...
 * </p>
 * <ul>
 *   <li>{@link trafficLightSystem.impl.BehaviorImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BehaviorImpl extends MinimalEObjectImpl.Container implements Behavior {
	...
	protected EClass eStaticClass() {
		return TrafficLightSystemPackage.Literals.BEHAVIOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TrafficLightSystemPackage.BEHAVIOR__NAME, oldName,
					name));
	}
