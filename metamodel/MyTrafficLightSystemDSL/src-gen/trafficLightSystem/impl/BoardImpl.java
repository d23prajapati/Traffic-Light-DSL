 ...
 * </p>
 * <ul>
 *   <li>{@link trafficLightSystem.impl.BoardImpl#getName <em>Name</em>}</li>
 *   <li>{@link trafficLightSystem.impl.BoardImpl#getPinGroups <em>Pin Groups</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoardImpl extends MinimalEObjectImpl.Container implements Board {
	...
	protected EClass eStaticClass() {
		return TrafficLightSystemPackage.Literals.BOARD;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TrafficLightSystemPackage.BOARD__NAME, oldName,
					name));
	}
	...
	public EList<PinGroup> getPinGroups() {
		if (pinGroups == null) {
			pinGroups = new EObjectContainmentEList<PinGroup>(PinGroup.class, this,
					TrafficLightSystemPackage.BOARD__PIN_GROUPS);
		}
		return pinGroups;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case TrafficLightSystemPackage.BOARD__PIN_GROUPS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TrafficLightSystemPackage.BOARD__NAME:
			return getName();
		case TrafficLightSystemPackage.BOARD__PIN_GROUPS:
			return getPinGroups();
		}
